...
async function createThaiQRCard(payload, targetId) {
    ...
    // 2. โลโก้แบรนด์ด้านบนสุด (ใช้ SVG ของ TrueMoney ถ้าเป็น e-Wallet)
    if (isTrueMoney) {
        const tmW = 160;
        const tmH = 65;
    ...
    const ppY = cardY + 105;
    await drawPromptPaySVG(ctx, ppX, ppY, ppW, ppH);
    ...
    // *หมายเหตุ: ตัดข้อความตัวเลข/ชื่อบัญชี และจำนวนเงินด้านล่างออกทั้งหมดเรียบร้อยแล้ว*
